  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 dark:from-slate-950 dark:via-blue-950/10 dark:to-indigo-950/10">
      <div className="container max-w-6xl py-12 space-y-8">
        ...
        {/* Search Section */}
        <Card className="p-8 border-2 border-indigo-100 dark:border-indigo-900/50 bg-gradient-to-br from-white via-indigo-50/30 to-purple-50/30 dark:from-slate-900 dark:via-indigo-950/20 dark:to-purple-950/20 shadow-xl shadow-indigo-500/5 relative overflow-hidden">
        ...
        <div className="space-y-4">
          {receivedRequests.length > 0 && (
            <div className="flex items-center gap-3 p-4 rounded-2xl bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/20 border-2 border-orange-200 dark:border-orange-900/30">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-lg shadow-orange-500/25">
          ...
          {totalCount > 0 ? (
            <Card className="p-6 border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-xl shadow-slate-500/5">
            ...
            <Card className="p-12 border-2 border-dashed border-slate-200 dark:border-slate-800 bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 text-center">
